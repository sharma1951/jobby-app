        ...
        <div className="job-item-container">
          <div className="first-part-container">
            ...
            <div className="second-part-container">
              ...
              <ul className="ul-job-details-container">
                {skills.map(eachItem => (
                  <li
                    className="li-job-details-container"
                    key={eachItem.name} // Use a suitable key
                  >
                    <img
                      className="skill-img"
          ...
          <ul className="similar-jobs-ul-container">
            {similarJobsData.map(eachItem => (
              <SimilarJobs
                key={eachItem.id} // Use a suitable key
                similarJobData={eachItem}
                employmentType={employmentType} // Pass employmentType if needed
              />
            ))}
          </ul>
        </div>
